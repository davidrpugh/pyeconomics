% RBC Model with indivisible labor and variable capacity utilization. 
%
...
% than basic RBC. 
% We can reduce standard deviation of shock by 70%.
%
...
model; 
  ...
  psi*c = (1-alpha)*((u*k(-1))^alpha)*(exp(z)^(1-alpha))*(l^(-alpha));
