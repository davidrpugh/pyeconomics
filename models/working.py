...
class Model(object):
    ...
    stochastic growth models with inelastic labor supply.
    ...
    def get_newCapital(self, k, c, z=1.0, **kwargs):
        ...
        k_t = \\frac{1}{(1+g)(1+n)}[(1-delta)k_{t-1}+f(k_{t-1})-c_t]
