...
program Fluctuations
	...
	sfac=0.5
		...
		print*, "KcoefD(1)=", KcoefD(1)
		print*, "KcoefD(2)=", KcoefD(2)
		...
		errK = maxval(dabs(NewKcoefG - KcoefG))+maxval(dabs(NewKcoefB - KcoefB))+maxval(dabs(NewKcoefD - KcoefD))
		

		KcoefG = sfac*NewKcoefG + (1.0D0 - sfac)*KcoefG
		KcoefB = sfac*NewKcoefB + (1.0D0 - sfac)*KcoefB		
		KcoefD = sfac*NewKcoefD + (1.0D0 - sfac)*KcoefD	
